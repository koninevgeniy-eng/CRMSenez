...
- `docs/MVP_PROCESS.md` — согласованный процесс MVP, роли, статусы, бюджет, календарь и закрытие мероприятия.
- `docs/IMPLEMENTATION_PLAN.md` — этапы переноса процесса в модель данных, API и интерфейс.
